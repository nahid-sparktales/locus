...
> [!NOTE]
> [Download Locus 3.1.0 for Apple Silicon](https://github.com/nahid-sparktales/locus/releases/download/v3.1.0/Locus-macOS.zip).
...
> [release notes](https://github.com/nahid-sparktales/locus/releases/tag/v3.1.0).
