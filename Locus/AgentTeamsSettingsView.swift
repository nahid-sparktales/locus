...
struct QuickTeamBuilderView: View {
    ...
    private enum Lane: String, CaseIterable, Identifiable {
        ...
        var symbol: String {
            switch self {
            case .dispatcher: "play.square.stack.fill"
...
private struct AgentBehaviorEditor: View {
    ...
    private var advancedFields: some View {
        VStack(alignment: .leading, spacing: 12) {
            Group {
                ...
                TextField("Grill Me", text: $draft.modeInstructions.grill, axis: .vertical)
            }
            Divider()
            Group {
    ...
    private var promptPreview: String {
        let overlay = [
            ...
            ("Grill Me", draft.modeInstructions.grill),
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 18) {
                ...
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    Text("Only Work, Plan, and Grill Me can save or recall these snapshots. Automatic recall is capped by the selected agent's memory policy; Just Chat never receives them.")
                        .font(.locus(size: 8))
                        .foregroundStyle(LocusTheme.muted)
                        .fixedSize(horizontal: false, vertical: true)
