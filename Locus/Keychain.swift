...
/// Keychain storage for the remote endpoint's API key.
///
/// The key never goes into UserDefaults or the agent's config file: it lives
/// in the login keychain and is handed to the local agent process in memory.
enum Keychain {
